...
namespace SevenWonders.WebAPI.Controllers
{
    public class ToursController : ApiController
    {
        ...
        public IHttpActionResult GetToursForManager(int pageIndex, int pageSize)
        {
            ...
            var data = db.Tours.Where(t => t.Reservation.RoomItem.Room.Hotel.City.Country.Manager.Id == manager.Id && !t.IsDeleted);
        ...
        public IHttpActionResult UpdateTours()
        {
            ...
            //List<Tour> data = db.Tours.Where(x=>!x.IsDeleted && x.Reservation.Room.RoomTypeHotel.Hotel.City.Country.Manager.Id== manager.Id).ToList();
        ...
        private TourModel convertToTourModel(Tour tour)
        {
            return new TourModel()
            {
                ...
                HotelName= tour.Reservation.RoomItem.Room.Hotel.Name
            };
        }
