...
function FlightModifyViewModel() {
    var self = this;
    ...
    self.AirplaneCompany = ko.observable().extend({ required: true, minLength: 2, maxLength: 40 })
    self.AirplaneModel = ko.observable().extend({ required: true, minLength: 2, maxLength: 40 })
